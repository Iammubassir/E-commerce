...
const ProductContextProvider = (props) => {
    ...
    const [products] = useReducer(ProductReducer, [
        {id: 1, name: 'DSLR Camera', price: 4000, image: dslr, productStatus: 'hot'},
        {id: 2, name: 'Perfume', price: 200, image: perfum,productStatus: 'new'},
        {id: 3, name: 'Watch', price: 300, image: watch,productStatus: 'new'},
        {id: 4, name: 'Shoes', price: 1500, image: shoes,productStatus: 'new'},
        ...
        {id: 7, name: 'Iphone X', price: 2400, image: iphone,productStatus: 'hot'},
